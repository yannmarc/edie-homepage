  ...
  return (
    <Fragment>
        <div className="px-6 max-w-5xl mx-auto pt-[150px]">
            <div className="text-2xl lg:text-4xl lg:w-[937px] md:max-w-xl lg:leading-[54px]"><h3>“Fast and outstanding resutls. Edie understands their customer’s needs. They have a young and talented team.”</h3></div>
